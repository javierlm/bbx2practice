...
import { savePasswordChangeAdmin } from "../../../services/UserService";
import {
  newPasswordAdminRequest,
  setNewPasswordAdminRequestAttribute,
} from "../../../actions/UserAction";

const ChangePasswordAdminForm = (props) => {
  ...
  const saveItem = async (event) => {
    ...
    savePasswordChangeAdmin(passWordChangeAdminRequest, SelectedUser).then(
      async (response) => {
  ...
  return (
    <div className={classes.modal}>
      <h3>Cambio de contraseña por administrador</h3>
      <ValidatorForm
...
ChangePasswordAdminForm.propTypes = {
